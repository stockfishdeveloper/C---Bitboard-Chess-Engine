...
const int Eval::Evaluate_Position(Position* position)
{
    ...
    int bpona = (__builtin_popcountll(position->Black_Pawns & A_Pawn_Mask) - 1);
    int bponb = (__builtin_popcountll(position->Black_Pawns & B_Pawn_Mask) - 1);
    int bponc = (__builtin_popcountll(position->Black_Pawns & C_Pawn_Mask) - 1);
    int bpond = (__builtin_popcountll(position->Black_Pawns & D_Pawn_Mask) - 1);
    int bpone = (__builtin_popcountll(position->Black_Pawns & E_Pawn_Mask) - 1);
    int bponf = (__builtin_popcountll(position->Black_Pawns & F_Pawn_Mask) - 1);
    int bpong = (__builtin_popcountll(position->Black_Pawns & G_Pawn_Mask) - 1);
    int bponh = (__builtin_popcountll(position->Black_Pawns & H_Pawn_Mask) - 1);
