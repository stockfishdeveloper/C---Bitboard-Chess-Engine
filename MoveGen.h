...
extern Bitboard White_Move_From_Stack[150];//Move stack is just an array of Bitboards(64-bit integers) containing only one bit set in each--the from square or the to square
extern Bitboard White_Move_To_Stack[150];
extern Bitboard Black_Move_From_Stack[150];
extern Bitboard Black_Move_To_Stack[150];
extern int White_Move_Types[150];//Array of normal integers that keeps track of the type of each move
extern int Black_Move_Types[150];
...
extern Bitboard WhiteQueenCount[150];
extern Bitboard BlackQueenCount[150];
